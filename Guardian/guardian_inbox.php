...
// Fetch messages
$sql = "SELECT Msg_id, patient_name, therapist_name, subject, message, sent_at FROM therapist_message ORDER BY sent_at DESC";
                    ...
                    echo "<tr>
                            ...
                            <td>
                                <form action='reply_message.php' method='POST'>
                                    ...
                                    <button><a href='gudian_sent_msg.php'>Reply</a></button>
                                </form>
                            </td>
                        </tr>";
                }
