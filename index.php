...
<br><br>
    ...
    <!-- Quick Website Tour -->
    <section id="Quick Website Tour">
        <div class="section">
            <center>
                <h3>QUICK WEBSITE TOUR</h3><br>
                <h4>Watch the explainer video</h4>
                <div class="website-tour-text">
                    <p>Watch this quick explainer video to get an overview of just what Vocal Vantage is all about and how it can support your practice.</p>
                </div><br>
                <button class="vedieo-button" >See More</button>
            </center>
            <div class="website-tour">
                <video width="520" height="340" controls>
    <source src="Resourses/sample_vid.mp4" type="video/mp4">
    <source src="Resourses/sample_vid.ogg" type="video/ogg">//*only imported sounds*//
   </video>
            </div>
        </div>
    </section>
